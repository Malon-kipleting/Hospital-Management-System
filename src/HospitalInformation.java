...
public class HospitalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/patient-icon-healthcare-icon-medical-icon-D51efEbd.jpg"))); // NOI18N
        ...
        jTextArea2.setText("A Hospital Management System(HMS) is an element of health informatics that focuses mainly on keeping records of patients.\nThis system enhances the ability of the system administrator or a reciptionist in ahealth center to easily access patient's data without straining to get it.\nPatients health information and visit history is available whenever needed");
